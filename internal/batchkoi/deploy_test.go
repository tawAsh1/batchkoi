...
func TestComputeRetention(t *testing.T) {
	cases := []struct {
		...
		// wantDereg/wantKept are []int32{} (never nil) — empty must marshal
		// as [] in -o json, not null.
		{"keep all when count 0", []int32{5, 4, 3}, 0, nil, []int32{}, []int32{5, 4, 3}},
		...
		{"keep count exceeds total", []int32{3, 2}, 5, nil, []int32{}, []int32{3, 2}},
		{"protect outside count", []int32{5, 4, 3, 2, 1}, 1, []int{3}, []int32{4, 2, 1}, []int32{5, 3}},
		{"empty input", []int32{}, 1, nil, []int32{}, []int32{}},
	}
